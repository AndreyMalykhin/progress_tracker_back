...
import { registerResetRewardableReviewCountTask } from "tasks/reset-rewardable-review-count-task";
...
registerResetRewardableReviewCountTask(commander, diContainer);
